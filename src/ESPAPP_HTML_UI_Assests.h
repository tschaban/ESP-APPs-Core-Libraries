...
const char HTML_UI_FORM_BLOCK_HEADER[] PROGMEM =
    "<div class=\"ci\"><h1>{{T}}</h1><p "
    "class=\"cd\">{{D}}</p><fieldset>";

const char HTML_UI_FORM_BLOCK_CLOSURE[] PROGMEM = "</fieldset></div>";

const char HTML_UI_INFO_TEXT[] PROGMEM = "<br><p class=\"cm\">{{i.v}}</p>";
...
const char HTML_UI_ITEM_HINT[] PROGMEM = "<br><p class=\"cm\">{{i.h}}</p>";
