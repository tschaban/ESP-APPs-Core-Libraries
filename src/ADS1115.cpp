...
bool ADS1115::init() {
    ...
    if (!isConnected()) {
#ifdef DEBUG
        this->System->Msg->printError(F("Device not found"), F("ADS1115"));
#endif
        return false;
    }
    
#ifdef DEBUG
    this->System->Msg->printInformation(F("Initialized"), F("ADS1115"));
    this->System->Msg->printBulletPoint(F("Address: 0x"));
...
#ifdef DEBUG
        this->System->Msg->printError(F("Invalid channel"), F("ADS1115"));
#endif
        return 0;
    }
