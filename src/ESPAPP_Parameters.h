...
#define ESPAPP_NETWORK_DEFAULT_CONNECTION_ATTEMPTS 20
#define ESPAPP_NETWORK_DEFAULT_WAIT_TIME 1
#define ESPAPP_NETWORK_DEFAULT_WAIT_SERIES 20
...
struct NETWORK
{
  ...
  uint8_t noConnectionAttempts;      // = ESPAPP_NETWORK_DEFAULT_CONNECTION_ATTEMPTS;
  uint8_t waitTimeConnections;       // = ESPAPP_NETWORK_DEFAULT_WAIT_TIME;
  uint8_t waitTimeSeries;            // = ESPAPP_NETWORK_DEFAULT_WAIT_TIME;
  uint8_t noFailuresToSwitchNetwork; // = ESPAPP_NETWORK_DEFAULT_SWITCH_NETWORK_AFTER;
  bool mDNS;
#if !defined(ESP32)
  uint8_t radioMod ESPAPP_NETWORK_DEFAULT_RADIO_MODE;
